...
public class BlocksCollection {
    ...
    public static final Block ELDER_PRISMARINE_BRICK_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.PRISMARINE).requiresTool());
    public static final Block ELDER_PRISMARINE_BRICK_WALL = new WallBlock(FabricBlockSettings.copyOf(Blocks.PRISMARINE).requiresTool());
    ...
    public static void Register(String modID) {
        ...
        Registry.register(Registries.BLOCK, new Identifier(modID, "elder_prismarine_brick_slab"), ELDER_PRISMARINE_BRICK_SLAB);
        Registry.register(Registries.ITEM, new Identifier(modID, "elder_prismarine_brick_slab"), new BlockItem(ELDER_PRISMARINE_BRICK_SLAB, new FabricItemSettings()));
        Registry.register(Registries.BLOCK, new Identifier(modID, "elder_prismarine_brick_wall"), ELDER_PRISMARINE_BRICK_WALL);
        Registry.register(Registries.ITEM, new Identifier(modID, "elder_prismarine_brick_wall"), new BlockItem(ELDER_PRISMARINE_BRICK_WALL, new FabricItemSettings()));
