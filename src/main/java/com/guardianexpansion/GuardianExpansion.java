...
public class GuardianExpansion implements ModInitializer {
	...
	private static final ItemGroup GUARDIAN_EXPANSION_GROUP = FabricItemGroup.builder()
		...
		.entries((context, entries) -> {
			...
			entries.add(BlocksCollection.ELDER_PRISMARINE_BRICK_STAIRS);
			entries.add(BlocksCollection.ELDER_PRISMARINE_BRICK_SLAB);
			entries.add(BlocksCollection.ELDER_PRISMARINE_BRICK_WALL);
