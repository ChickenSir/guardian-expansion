...
public class GuardianExpansionDataGenerator implements DataGeneratorEntrypoint {
    ...
    private static class GEBlockTagGenerator extends BlockTagProvider {
        ...
        protected void configure(RegistryWrapper.WrapperLookup arg) {
            ...
            getOrCreateTagBuilder(BlockTags.SLABS)
                ...
                .add(BlocksCollection.ELDER_PRISMARINE_BRICK_SLAB)
                .add(BlocksCollection.ELDER_DARK_PRISMARINE_SLAB);

            getOrCreateTagBuilder(BlockTags.STAIRS)
                .add(BlocksCollection.ELDER_PRISMARINE_STAIRS)
                .add(BlocksCollection.ELDER_PRISMARINE_BRICK_STAIRS)
    ...
    private static class GERecipeProvider extends FabricRecipeProvider {
        ...
        public void generate(Consumer<RecipeJsonProvider> exporter) {
            ...
            createStairsRecipe(BlocksCollection.ELDER_PRISMARINE_BRICK_STAIRS, Ingredient.ofItems(BlocksCollection.ELDER_PRISMARINE_BRICKS))
                .criterion(hasItem(BlocksCollection.ELDER_PRISMARINE_BRICKS), conditionsFromItem(BlocksCollection.ELDER_PRISMARINE_BRICKS))
                .offerTo(exporter, new Identifier(getRecipeName(BlocksCollection.ELDER_PRISMARINE_BRICK_STAIRS)));
            ...
            createSlabRecipe(RecipeCategory.BUILDING_BLOCKS, BlocksCollection.ELDER_PRISMARINE_BRICK_SLAB, Ingredient.ofItems(BlocksCollection.ELDER_PRISMARINE_BRICKS))
                .criterion(hasItem(BlocksCollection.ELDER_PRISMARINE_BRICKS), conditionsFromItem(BlocksCollection.ELDER_PRISMARINE_BRICKS))
                .offerTo(exporter, new Identifier(getRecipeName(BlocksCollection.ELDER_PRISMARINE_BRICK_SLAB)));
